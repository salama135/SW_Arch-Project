...
namespace BPT_Consumer.BPT_Service {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/DeleteUserBloodRecoreds", ReplyAction="http://tempuri.org/IService1/DeleteUserBloodRecoredsResponse")]
        void DeleteUserBloodRecoreds(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/DeleteUserBloodRecoreds", ReplyAction="http://tempuri.org/IService1/DeleteUserBloodRecoredsResponse")]
        System.Threading.Tasks.Task DeleteUserBloodRecoredsAsync(int id);
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<BPT_Consumer.BPT_Service.IService1>, BPT_Consumer.BPT_Service.IService1 {
        ...
        public string SendEmail(string recipientEmail, string subject, string body, bool isHtml, string senderEmail, string senderPassword) {
            return base.Channel.SendEmail(recipientEmail, subject, body, isHtml, senderEmail, senderPassword);
        }
        ...
        public bool SendReminder(string subject, string body, bool isHtml, string senderEmail, string senderPassword) {
            return base.Channel.SendReminder(subject, body, isHtml, senderEmail, senderPassword);
        }
        ...
        public void DeleteUserBloodRecoreds(int id) {
            base.Channel.DeleteUserBloodRecoreds(id);
        }
        
        public System.Threading.Tasks.Task DeleteUserBloodRecoredsAsync(int id) {
            return base.Channel.DeleteUserBloodRecoredsAsync(id);
        }
